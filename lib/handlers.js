...
handlers._users.get = function(data, callback) {
  ...
  if(phone) {
    ...
    handlers._tokens.veriufyToken(token, phone, function(tokenIsValid) {
      if(tokenIsValid) {
        // lookup the user
        _data.read('users', phone, function(err, data) {
          if(!err && data) {
...
handlers._tokens.veriufyToken = function(id, phone, callback) {
  // Look up the token
  _data.read('tokens', id, function(err, tokenData) {
    if(!err && tokenData) {
...
// Optional data: none
hanhandlers._checks.post = function(data, callback) {
  // Validate inputs
